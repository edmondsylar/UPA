                                       ...
                                       <div class="row">
                                           <form class="col s12">
                                               ...
                                               <div class="col s12 right-align m-t-sm">
                                                   <a href="login.php" class="waves-effect waves-grey btn-flat">login</a>
                                                   <input type="submit" onclick="validator()" class="waves-effect waves-light btn teal" value="register">
                                               </div>
                                           </form>
                                      </div>
                                  </div>
